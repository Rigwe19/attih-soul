...
const images: AlbumImage[] = [
    {
        id: 1, src: '/images/album/shades.webp',
        alt: 'Image 1',
        name: "Shades of Emotions",
        links: {
            apple: "https://music.apple.com/ng/album/shades-of-emotions/1716933890",
            youtube: 'https://music.youtube.com/playlist?list=OLAK5uy_mcNauihigWXqNyNMykvfLHjhzSAmUWeoA&si=k3OaELp9ftYapQ_o',
            spotify: 'https://open.spotify.com/album/1Y1pA4oVthGaYLuRqv1Ryo?si=63KqMb93SHan5LKVb2hI8w',
            deezer: 'https://dzr.page.link/JBgHpb3PWmURVhVv9',
            tidal: 'https://tidal.com/browse/album/329149777'
        }
    },
    // { id: 2, src: '/images/album/album2.webp', alt: 'Image 2' },
    // { id: 3, src: '/images/album/album3.webp', alt: 'Image 3' },
    // { id: 4, src: '/images/album/album4.webp', alt: 'Image 4' },
];
const Album = () => {
    ...
    return (
        <div className="w-full relative">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 grid-cols-1 relative p-4 md:transition-all md:duration-1000">
                {images.map((image) => (
                    <motion.div
                        key={image.id}
                    ...
                    >
                        ...
                        <div className="absolute w-full inset-0 flex transition-opacity duration-500 md:group-hover:opacity-100 md:opacity-0 justify-center mt-4">
                            <div className="w-2/3 flex items-center justify-center flex-col gap-4">
                                <p className="uppercase font-bold tracking-[2px] md:tracking-[4.3px]">{image.name}</p><div className="flex gap-5">
                                    <a href={image.links.apple} target="_blank" className="">
                                    ...
                                    <a href={image.links.youtube} target="_blank" className="">
                                    ...
                                    <a href={image.links.spotify} target="_blank" className="">
                                    ...
                                    <a href={image.links.tidal} target="_blank" className="">
                                    ...
                                    <a href={image.links.deezer} target="_blank" className="">
            ...
            {/* <AnimatePresence>
                {hoveredId === 1 && <motion.div className="grid grid-cols-4 p-4 absolute inset-0 z-10 pointer-events-none">
                    <motion.div
                        ...
                        >
                            <img src="/images/album/shades.webp" className="object-cover brightness-25 h-full" alt="" />
                        ...
                        <img src="/images/album/shades.webp" className="w-1/2 h-full object-cover" alt="" />
                    </motion.div>
                    <motion.div
                        animate={{
                            translateX: '0',
                        ...
                        <img src="/images/album/album3.webp" className="w-full h-full object-cover" alt="" />
                    </motion.div>
                    <motion.div
                        animate={{
                            x: '0',
                        ...
                        <img src="/images/album/album4.webp" className="w-full h-full object-cover object-center]" alt="" />
                    </motion.div>
                </motion.div>}
                {hoveredId === 2 && <motion.div className="grid grid-cols-4 p-4 absolute inset-0 z-10 pointer-events-none">
                    <motion.div className="">
                        <img src="/images/album/shades.webp" className="object-cover h-full" alt="" />
                    </motion.div>
                    <motion.div
                        animate={{
                            opacity: 1,
                        ...
                        <div className="w-1/2 relative pointer-events-auto"
                            ...
                            onMouseLeave={(e) => setHoveredId(null)}
                        >
                            <img src="/images/album/album2.webp" className="object-cover brightness-25 h-full" alt="" />
                            <div className="absolute inset-0 flex items-center justify-center flex-col gap-4">
                                <p className="uppercase">Album Name</p>
                                <Button className="border border-white text-white bg-transparent w-2/3">Watch Here</Button>
                            </div>
                        ...
                        <img src="/images/album/album2.webp" className="w-1/2 h-full object-cover" alt="" />
                    </motion.div>
                    <motion.div className="">
                        <img src="/images/album/album4.webp" className="h-full object-cover" alt="" />
                    </motion.div>
                </motion.div>}
                {hoveredId === 3 && <motion.div className="grid grid-cols-4 p-4 absolute inset-0 z-10 pointer-events-none">
                    <motion.div className="">
                        <img src="/images/album/shades.webp" className="h-full object-cover" alt="" />
                    </motion.div>
                    <motion.div className="">
                        <img src="/images/album/album2.webp" className="h-full object-cover" alt="" />
                    </motion.div>
                    <motion.div
                        animate={{
                            opacity: 1
                        ...
                        <div className="w-1/2 relative pointer-events-auto"
                            ...
                            onMouseLeave={(e) => setHoveredId(null)}
                        >
                            <img src="/images/album/album3.webp" className="object-cover brightness-25 h-full" alt="" />
                            <div className="absolute inset-0 flex items-center justify-center flex-col gap-4">
                                <p className="uppercase">Album Name</p>
                                <Button className="border border-white text-white bg-transparent w-2/3">Watch Here</Button>
                            </div>
                        ...
                        <img src="/images/album/album3.webp" className="w-1/2 h-full object-cover" alt="" />
                    </motion.div>
                </motion.div>}
                {hoveredId === 4 && <motion.div className="grid grid-cols-4 p-4 absolute inset-0 z-10 pointer-events-none">
                    ...
                    <motion.div className="">
                        <img src="/images/album/album2.webp" className="object-cover  h-full" alt="" />
                    </motion.div>
                    <motion.div
                        animate={{
                            opacity: 1
                        ...
                        <img src="/images/album/album4.webp" className="w-1/2 h-full object-cover" alt="" />
                        <div className="w-1/2 relative pointer-events-auto h-full"
                            onMouseEnter={(e) => handleImageHovered(selectedImage!, e)}
                            onMouseLeave={(e) => setHoveredId(null)}
                        >
                            <img src="/images/album/album4.webp" className="object-cover brightness-25 h-full" alt="" />
                            <div className="absolute inset-0 flex items-center justify-center flex-col gap-4">
                                <p className="uppercase">Album Name</p>
                                <Button className="border border-white text-white bg-transparent w-2/3">Watch Here</Button>
                            </div>
